...
from utils.constants.template_verbs import GOTO_VERBS, PICKUP_VERBS
from utils.objaverse_annotation import get_objaverse_annotations
from utils.synset_utils import get_all_synsets_in_spoc, generate_all_hypernyms_with_exclusions
